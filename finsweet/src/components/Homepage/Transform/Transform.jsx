    ...
    <section className={styles.transform}>
        <div className={styles.transform_top}>
            <div className={styles.transform_text}>
                ...
                <SimpleText new_styles={{color: 'rgba(255, 255, 255, 1)', opacity: '60%'}} text="The entire Finsweet team knows what's good with Webflow and you can too with 1 week and a good attitude."/>
